...
X_train, X_test, y_train, y_test, weights_train, weights_test, names_train, names_test = train_test_xywnames_split(X, y, w, names, training_split=training_split)
print("Done.\n")
...
### Embedding techniques comparison
# embedding_techniques_comparison(X_train, y_train, names_train, embeddings, None, fig_size=(15, 7.5))
