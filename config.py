...
photo_dir = "/media/shared_storage/datasets/I3DCP/texture_windows"
label_path = "/media/shared_storage/google-drive/Descargas/r_e-balanced.csv"

# Parameters to generate dataset
expert = "annotator_1"  # Choose only the labels provided by this person if agreement_weights is 'None' or if there is not a majority label in the vector of labels for a single image
...
min_features_to_select = 10  # Minimum number of features to consider in cv feature elimination
max_features_to_select = 32  # For feature selection without cv
folds = 5  # Folds used for cross-validation or cv feature elimination
